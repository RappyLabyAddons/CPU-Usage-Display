...
3. It should open your Labymod addon directory; Paste the [CPU-Usage-Display.jar](https://github.com/RappyLabyAddons/CPU-Usage-Display/releases/download/1.1.0/CPU-Info.jar) in there.
